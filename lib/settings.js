 ...
 * @type {string}
 */
const defaultSettingsDir = path.join(process.env.PWD || process.cwd(), 'data');
const defaultSettingsFilePath = path.join(process.env.PWD || process.cwd(), 'data/config.json');
